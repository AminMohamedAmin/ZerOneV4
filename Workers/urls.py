...
urlpatterns = [
    ...
    path('detail/attendance/<int:pk>/hour/', WorkerAttendance_Hour.as_view(), name="WorkerAttendance_Hour"),
    ...
    path('detail/production/<int:pk>/product/', Worker_Production_Product.as_view(), name="WorkerProductions_Product"),
